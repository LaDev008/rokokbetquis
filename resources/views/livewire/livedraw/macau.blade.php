    <div class="col-lg-6 col-12" wire:poll.6000ms='liveFeed'>
        ...
        <table
            class="table-bordered border-info fw-bold table border-2 border text-center text-white bg-dark align-middle custom-font">
            <thead>
        ...
        <livewire:components.livedraw-links first="sydney" second="singapore" third="hongkong" fourth="kingkong"/>
    </div>
