    ...
    <form wire:submit.prevent='submit' class="d-flex flex-column align-items-center gap-3 p-5 col-8 mx-auto bg-dark"
        ...
        <div class="col-12 d-flex gap-2">
            ...
            <div class="col" style="max-width: 50%;">
                <label>OLD</label>
                @if ($old_background)
                    <img src="{{ $old_background }}" alt="" class="w-100">
                @endif
            </div>
            <div class="col">
                <label>NEW</label>
                @if ($background)
                    <img src="{{ $background->temporaryUrl() }}" alt="" class="w-100">
                @endif
            </div>
        </div>
        ...
        <div class="col-12 d-flex gap-2">
            ...
            <div class="col" style="max-width: 50%;">
                <label>OLD</label>
                @if ($old_photo)
                    <img src="{{ $old_photo }}" alt="" class="w-100">
                @endif
            </div>
            <div class="col">
                <label>NEW</label>
        ...
        <div class="input-group">
            <label for="background" class="input-group-text">Logo Pasaran</label>
