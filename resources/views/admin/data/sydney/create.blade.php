...
<div class="p-4 d-flex flex-column gap-4">
    <h1 class="text-center">Data Sydney</h1>

    <form action="{{route("admin.data.sydney.store")}}" method="POST">
        @csrf
        <div class="input-group mb-3">
            <span class="input-group-text" id="firstResult">Tanggal</span>
            <input type="date" class="form-control" aria-label="first_result"
                aria-describedby="firstResult" name='date' value="{{ Carbon\Carbon::now()->format('Y-m-d') }}">
        </div>
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="-" aria-label="first_result"
                aria-describedby="firstResult" name='first_result' value="">
        </div>
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="-" aria-label="second_result"
                aria-describedby="secondResult" name='second_result' value="">
        </div>
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="-" aria-label="third_result"
                aria-describedby="thirdResult" name='third_result' value="">
        </div>
