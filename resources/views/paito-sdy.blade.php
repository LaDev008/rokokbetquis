    ...
    <table id="drawing-table" class="noselect mt-2 mb-3" border="1" width="100%">
        <thead>
            <tr>
                ...
                <th class="cell-gradient text-center" class="">D</th>
        ...
        @php
            ...
            $data_sdy = Sydney::orderByDesc('date')
                ->get()
        ...
        @endphp
        <tbody>
            @foreach ($data_sdy as $week => $items)
                <tr>
                    @php
...
foreach ($items as $item) {
    ...
    <script type="text/javascript" src="/storage/sdy/script-live.js"></script>
    <script type="text/javascript" src="/storage/sdy/script-lite.js"></script>
    <script type="text/javascript" src="/storage/sdy/script-site.js"></script>
@endsection
