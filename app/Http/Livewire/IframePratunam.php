...
class IframePratunam extends Component
{
    public $return_value = [];
    ...
    public function getLive()
    {
        ...
        $pecah1 = explode('<h3 class="judul-subkolom Pratunampoolstoday" align="center">', $html);
    ...
    {
        return view('livewire.iframe-pratunam', $this->return_value);
    }
}
