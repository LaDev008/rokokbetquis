...
class IframeKrabi extends Component
{
    public $return_value = [];
    ...
    public function getLive()
    {
        ...
        $pecah1 = explode('<h3 class="judul-subkolom Krabipoolstoday" align="center">', $html);
    ...
    {
        return view('livewire.iframe-krabi', $this->return_value);
    }
}
