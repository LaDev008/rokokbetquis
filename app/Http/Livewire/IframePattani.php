...
class IframePattani extends Component
{
    public $return_value = [];
    ...
    public function getLive()
    {
        ...
        $pecah1 = explode('<h3 class="judul-subkolom Pattanipoolstoday" align="center">', $html);
    ...
    {
        return view('livewire.iframe-pattani',  $this->return_value);
    }
}
